...
*/
//admin
Route::get('/mail', [Controllername::class, 'testmail']);
...
Route::get('/xoabinhluan/{id_bl}', [AdminController::class, 'xoabinhluan']);
//danhmuc   
...
Route::get('/muahang', [khachhang::class, 'donhang']);
//taikhoan
Route::get('/lietketaikhoan', [taikhoan::class, 'lietketaikhoan']);
Route::get('/thongke', [taikhoan::class, 'thongke']);
...
Route::POST('/binh-luan', [sanpham::class, 'binh_luan']);
Route::POST('/gui-binh-luan', [sanpham::class, 'gui_binh_luan']);
// Route::get('/chitiet/{id_ma_sp}', [sanpham::class, 'binhluan']);
//donhang
Route::get('/donhang', [CartController::class, 'donhang']);
Route::get('/suadonhang/{id_hd}', [CartController::class, 'suadonhang']);
Route::get('/sua-donhang/{id_hd}', [CartController::class, 'sua_donhang']);
Route::get('/huydonhang/{id_hd}', [CartController::class, 'huy_donhang']);
Route::post('/save-cart', [CartController::class, 'index']);
Route::get('/giohang', [CartController::class, 'show']);
// Route::get('/giohang', [CartController::class, 'show1']);
Route::get('/xoa/{id_sp}', [CartController::class, 'delete']);
Route::post('/capnhatgiohang', [CartController::class, 'update']);
Route::post('/giohang', [CartController::class, 'thanhtoan']);
//danh muc home
Route::get('/loaisp/{id_ma_loai_sp}', [Controllername::class, 'loaisp']);
Route::get('/danhmuc', [Controllername::class, 'danhmuc']);
Route::post('/lienhe', [Controllername::class, 'lien_he']);
...
Route::get('/canhan', [Controllername::class, 'canhan']);
Route::get('/suacanhan', [Controllername::class, 'suacanhan']);
Route::POST('/sua-canhan', [Controllername::class, 'sua_canhan']);